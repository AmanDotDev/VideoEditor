  ...
  ({ video, index }: VideoResourceProps) => {
    ...
    return (
      <div className="rounded-lg overflow-hidden items-center bg-slate-800 m-[15px] flex flex-col relative">
        ...
        <button
          className="hover:bg-yellow-600 bg-[rgba(0,0,0,.25)] rounded z-10 text-white font-bold py-1 absolute text-lg bottom-2 right-2"
        ...
        <video
          ...
          ref={ref}
          className="max-h-[full] p-1 max-w-[full]"
          src={video}
          height={200}
          width={250}
          id={`video-${index}`}
